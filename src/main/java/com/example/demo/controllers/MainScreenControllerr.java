...
public class MainScreenControllerr {
 ...
 /*   public MainScreenControllerr(PartRepository partRepository, ProductRepository productRepository) {
    ...
    public String listPartsandProducts(Model theModel, @RequestParam(value="partkeyword", required=false) String partkeyword, @RequestParam(value="productkeyword", required=false) String productkeyword){
